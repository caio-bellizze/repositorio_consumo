...
if st.button("Calcular") and empresa_filtro:
    ...
    colunas_tabela = ["CNPJ", "Número de unidades", "Cidade", "Estado", "Ramo", "Carga somada por submercado"]
    df_tabela = df_empresa.groupby("CNPJ")[["Número de unidades", "Cidade", "Estado", "Ramo", "Carga somada por submercado"]].first().reset_index()
